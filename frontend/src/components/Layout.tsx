...
import {
  ...
  MapPinned, Layers, BellRing, LogOut, Menu, X, ChevronRight, ChevronDown, CreditCard, Wallet, KeyRound, Shirt, BarChart3, Megaphone
} from 'lucide-react'
...
const menu = [
  ...
  { grupo: 'El día', items: [
    ...
    { path: '/preparacion',     label: 'Preparación y cargas', icon: Layers,       ver: [...TODOS_OPERATIVOS, 'ASISTENTE'] },
    { path: '/produccion',      label: 'Producción',        icon: ScanLine,        ver: [...TODOS_OPERATIVOS, 'ASISTENTE'] },
    { path: '/avisos',          label: 'Avisos pendientes', icon: BellRing,        ver: [...TODOS_OPERATIVOS, 'ASISTENTE'] },
